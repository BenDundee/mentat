# Mentat: For the Penny Pinching Executive
Executives realize the value of a good coach, and the best can charge in excess of \$1000 an hour. Who in the world can 
afford that??? We are going to build a $10/month chatbot that does the same thing.

Coaches typically work on a regular cadence, with weekly or bi-weekly check-ins. This cadence establishes a personal relationship
...
The Coach will seek to understand the Client's:
  - Role, tenure in current position, and career trajectory
  - Current "fires", anything urgent
  - Immediate professional development goals
  - Career goals, 3-year and 5-year plan
...
Given this information, the Coach will synthesize two or three working focus areas to anchor the engagement and present these 
...
richer context, and it creates a benchmark for progress. The assessment will cover the following areas: 
  ...
  - patterns the client has noticed in themselves (feedback they hear repeatedly, situations where they consistently struggle), 
...
The Client should have comprehensive answers to the following questions before the session begins:
  ...
  - what they most want to work on today
...
discover it's really about the Client's relationship with a particular stakeholder, or their fear of being seen as not 
strategic enough. The agenda-setting conversation can redirect the whole session before it's really started.
...
What's actually happening, who's involved, what has the Client tried, what do they want. Coaches are trained to stay in 
exploration longer than feels comfortable. Clients want to jump to solutions, a good Coach slows that down.
  - *Shifting perspective.* This is often where the real value lives. Questions like "what would your most effective self 
do here," or "what would you tell a colleague who came to you with this situation," or "what are you assuming that might 
not be true." These create cognitive distance from the problem and open up options the Client couldn't see when they were 
inside it.
  - *Surfacing patterns.* The Coach will look for moments to connect the current situation to prior ones. "This sounds 
similar to what you described with your previous team — do you see a connection?" The best Coaches maintain this context,
and can surface it when necessary.
  - *Working with resistance.* When a client keeps returning to why something won't work, or deflects toward external 
causes, that's information. The Coach doesn't push through resistance, they get curious about it. "It sounds like part of 
...
what's your plan if it does?" That question dramatically increases follow-through.

The Coach may also assign a writing prompt for the Client. This may be a reflection on progress (or lack thereof), or 
something designed to help the Client shift their perspective, for example.
...
Hyper-Achiever feels like ambition. The Judge feels like discernment. The Controller feels like leadership. That's what 
makes them hard to dislodge through willpower alone — you have to first see them clearly for what they are.
...
#### The Sage Perspective and Five Powers
The Sage operates from a foundational belief that every problem or challenge can be converted into a gift or opportunity. 
That's not toxic positivity — it's a practiced orientation that prevents the nervous system from treating every 
difficulty as a threat.

The Sage has five specific powers it can bring to any situation:
  - Empathize — with yourself and others, generating compassion rather than judgment. This is the antidote to the Judge. 
  - Explore — with curiosity and open-mindedness rather than anxiety. Treating situations as interesting rather than threatening. 
  - Innovate — generating new perspectives and creative ideas that aren't accessible when the Saboteurs are running the show. 
  - Navigate — connecting to deeper values and purpose to determine the right direction. Less about tactics and more about meaning. 
  - Activate — taking decisive action without the interference of Saboteur-generated doubt, guilt, or anxiety.

In any given challenging situation, a Sage-guided response moves through empathy and exploration before arriving at 
action. Saboteurs typically skip straight to judgment and reaction.

#### Mental Fitness and the PQ Rep
Chamine borrows from physical fitness as his primary metaphor. Just as you build physical fitness through reps in the 
gym, you build mental fitness through PQ reps — brief practices that strengthen the Sage and weaken the Saboteurs by 
shifting activation from the prefrontal cortex (where Saboteurs live) to other brain regions associated with positive 
emotion and clear perception.
...
minutes total distributed across the day. The goal is to build the habit of noticing when a Saboteur has hijacked your 
